...
const $=id=>document.getElementById(id),plain=v=>String(v||'').replace(/<br\s*\/?\s*>/gi,'\n'),norm=v=>plain(v).toLowerCase().replace(/\s+/g,''),esc=v=>String(v).replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));
